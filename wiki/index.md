...
- [[ReferralProgram-History-UI-Design]] (c-000229) — UI истории изменений по офферам/лидам/корешкам: раздельные кнопки истории для оффера и для корешка, объединение в одну историю явно отвергнуто (status: developing)
