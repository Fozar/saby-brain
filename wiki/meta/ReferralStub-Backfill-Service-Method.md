...
## Обновление 2026-07-30 — баг «не находит сделки», включено в версию 4100

Заведён баг на стенде: `ReferralProgram.CreateStubsForExistingLeads` не находит сделки (source: [[createstubsforexistingleads-bug-4100-2026-07-30]]). Причина не задокументирована источником — только координация: Тимошенко попросил [[Земцова-Анастасия|Земцову А.]] включить метод в версию **4100**, через ~2.5 часа она подтвердила включение. Метод остаётся на этапе обкатки (§«Порядок сдачи», пункт 2) — открытые пункты выше не закрыты этим источником.