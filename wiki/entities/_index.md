...
- [[Морозов-Алексей-Васильевич]] — ревьюер/автор правок документации по [[Route-Platform-Architecture]]; роль и подразделение не подтверждены (status: stub)
...
- [[Окладников-Д]] — разработчик, совладелец Платформы Маршрутов (авто-проходчик, этапы Действие/Ожидание, карточка прохода) в проекте [[CustomerJourney-Scenarios-Project]] (status: current)
- [[Чусовитин-Александр]] — разработчик, совладелец Платформы Маршрутов; ⚠️ вероятный дубль [[Чусовитин-Александр]] (тот же проект, другой источник — `План работ по проекту.pdf`), требует ручной проверки перед слиянием (status: current)
...
- [[Морозов-Алексей-Васильевич]] — руководитель проекта «Путь клиента» (45 чд руководство+проектирование), подписант плана тестирования; ⚠️ вероятный дубль стаб-страницы [[Морозов-Алексей-Васильевич]] — не сведено (status: current)
- [[Чусовитин-Александр]] — ответственный за постановку клиента на маршрут и авто-проходчик (этапы 1.3/1.4/2.1/2.2/2.4/2.5, ~126 чд), из `План работ по проекту.pdf`; ⚠️ уже отмечен как вероятный дубль [[Чусовитин-Александр]] выше — не сведено (status: current)
