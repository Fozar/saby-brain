...
- [[Морозов-Алексей-Васильевич]] — руководитель проекта «Путь клиента» (45 чд руководство+проектирование), подписант плана тестирования; также ревьюер сценарных мокапов (7 аннотаций-пометок) (status: current)
...
- [[Чусовитин-Александр]] — разработчик, совладелец Платформы Маршрутов (с [[Окладников-Д]]); ответственный за постановку клиента на маршрут и авто-проходчик (этапы 1.3/1.4/2.1/2.2/2.4/2.5, ~126 чд) (status: current)
