...
- [[Wasaby-Scripts]] — DeveloperScript: выполнение кода через DWC; .orx объект; архивирование; ВНР; результаты; отчёт выполнения; файлы клиентов по стендам (status: current)
- [[BL-Module-Dependency-Graphviz]] — визуализация зависимостей БЛ-модулей через Graphviz: sandbox-инструмент S3modToGraphviz, DOT-граф из s3mod-файлов (status: current)
