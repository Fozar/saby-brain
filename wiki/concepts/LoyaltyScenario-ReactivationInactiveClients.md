...
Extracted from v1 of the design doc: [[loyalty-scenario-reactivation-inactive-v1-2026-07-03]]. A sibling document with edits/comments from **Морозов** covers the same scenario and is being ingested separately — once ingested, diff against this page for resolved TODOs (e.g. the missing "Покупали" filter, the expiration-date field, the timeout-branch action) and flag any contradictions.
