...
**What it is**: Connect the MCP server that stores Claude's memories as Markdown entities with `\[\[wikilinks\]\]` syntax → they appear in Obsidian graph view automatically.
